...
export class JwtAuthService {
  ...
  async storeTokensInCookie(res: ResponseType, authToken: AuthTokenDto) {
    res.cookie('access_token', authToken.accessToken, { maxAge: +ms(this.authConf.jwt.access.expires_in), httpOnly: true });
    res.cookie('refresh_token', authToken.refreshToken, { maxAge: +ms(this.authConf.jwt.refresh.expires_in), httpOnly: true });
    return authToken;
  }
}